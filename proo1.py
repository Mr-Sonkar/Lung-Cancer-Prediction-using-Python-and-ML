...
# Load the dataset
dataset = pd.read_csv(r"C:\Users\lagad\Downloads\Project\Project123\cancer patient data sets (2).csv") #raw string literal
...
if nav_type == "Home":
    ...
    st.image(r"C:\Users\lagad\Downloads\Project\Project123\LungCancer_1400b.png", width=500)
